...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/26 15:36:19 by vtran             #+#    #+#             */
/*   Updated: 2019/11/28 13:40:51 by vtran            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			parse(t_print **p)
{
	...
	if (*tmp->fmt == '%')
		tmp->buf = tmp->pad ? \
		ft_memjoin(p, padding(&tmp, ft_memset(ft_strnew(1), '%', 1)), \
		tmp->pad) : ft_memjoin(p, ft_strdup("%"), 1);
